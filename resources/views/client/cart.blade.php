                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="pro-thumbnail-info text-left">
                                            ...
                                            <p>{{$p->options->brand_name}}</p>
                                        </div>
                                    </td>
                                    <td class="product-price">{{$p->options->promotion_price}}</td>
                                    <td class="product-quantity">
                                           {{$p->qty}}
                                    </td>
                                    <td class="product-subtotal">{{$p->options->promotion_price * $p->qty}}</td>
                                    <td >
                                        <form action="remove/{{$p->rowId}}" method="get">
                                            @csrf
                                ...
                                <div class="panel">
                                    ...
                                    <div id="bank-transfer" class="panel-collapse collapse in">
                                        <div class="payment-content">
                                            <p>Lorem Ipsum is simply in dummy text of the printing and type setting
